...
public class ApuntesDao {
    ...
    public void crearApunte(Integer idUsuario, Integer idMateria, String titulo, String descripcion, String archivoUrl) throws SQLException {
        String sql = "INSERT INTO publicaciones_foro (id_categoria, id_usuario, titulo, contenido, tipo_publicacion, archivo_url) VALUES (?, ?, ?, ?, 'Apuntes', ?)";
        try (Connection cn = Database.getConnection();
             PreparedStatement ps = cn.prepareStatement(sql)) {
            ps.setObject(1, idMateria);
    ...
    public List<Map<String, Object>> listarPublicacionesApuntes() throws SQLException {
        ...
        String sql = "SELECT p.*, "
                   ...
                   + "WHERE p.tipo_publicacion = 'Apuntes' "
                   + "  AND p.estado <> 'oculta' " // <-- CORRECCIÓN: Filtra los apuntes ocultados por el usuario
