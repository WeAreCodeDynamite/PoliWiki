                            ...
                            %>
                                <a href="#" 
                                   ...
                                   title="Editar publicación">
                                     <i class="fa-solid fa-pen-to-square" style="color: #4a5568; cursor: pointer; font-size: 1.1rem;"></i>
                                </a>
       ...
       onchange="actualizarNombreArchivo(this)" />
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                // Validación para levantar el modal de éxito con el mensaje dinámico del Servlet
