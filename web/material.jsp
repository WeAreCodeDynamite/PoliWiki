...
<html>
    ...
    <body>
            ...
            <div class="informar">
                <div class="lista-cards" id="listaPreguntas">
                    ...
                    <article class="card-dato">
                            ...
                            <div class="card-contenido-izq" style="width: 100%;">
                                <div class="usuario-bloque">
                                    ...
                                    <div class="usuario-info">
                                        <span class="usuario-nombre"><%= publicacion.get("autor") != null ? publicacion.get("autor") : "Anónimo" %></span>
                                        <span class="usuario-carrera"><%= publicacion.get("nombre_carrera") != null ? publicacion.get("nombre_carrera") : "Sin carrera" %></span>
                                    </div>
                                </div>
                                <div class="badge-tipo pregunta" style="background-color: #e0f7fa; color: #006064; display: inline-block; padding: 4px 8px; border-radius: 4px; font-size: 0.75rem; font-weight: bold; margin: 10px 0;">❓ PREGUNTA</div>
                        ...
                        <div class="card-footer" style="margin-top: 15px; padding-top: 10px; border-top: 1px solid #eee; display: flex; justify-content: space-between; align-items: center; color: #777; font-size: 0.85rem;">
                            ...
                            <div class="footer-der" style="display: flex; gap: 12px; align-items: center;">
                                <% if (tienePermisos) { %>
                                    <a href="#" class="btn-editar-dinamico"
                                       ...
                                       style="text-decoration: none;" title="Editar publicación" onclick="abrirModalEditar(this); return false;">
                                         <i class="fa-solid fa-pen-to-square" style="color: #0056b3; cursor: pointer; font-size: 1.1rem;"></i>
                                    </a>
                                    <a href="#" style="text-decoration: none;" title="Eliminar publicación" onclick="abrirModalEliminar('<%= publicacion.get("id_publicacion") %>', '<%= tituloLimpio %>'); return false;">
                    ...
                    <%    }
                        ...
                        <div class="card-dato" style="text-align: center; padding: 40px; color: #777;">No hay preguntas registradas en este momento.</div>
                    <% } else { %>
        ...
        <div id="modalExitoProfesor" class="modal-alert-overlay">
        ...
        <div id="modalConfirmarEliminar" class="modal-alert-overlay">
            <div class="modal-alert-content" style="border-top: 5px solid #d32f2f;">
                ...
                <div style="display: flex; gap: 15px; justify-content: center; margin-top: 20px;">
                    <button class="btn-modal-cancelar-img" onclick="cerrarModalConfirmar()">Cancelar</button>
                    <button id="btnAceptarEliminar" class="btn-modal-aceptar-img">Aceptar</button>
                </div>
            </div>
        </div>
        ...
        <div id="modalPregunta" class="modal-foros">
            <div class="modal-contenido">
                ...
                <form action="GuardarPublicacionServlet" method="POST" id="formPublicacion">
                    ...
                    <div class="grupo-formulario">
                        ...
                        <input type="text" id="temas" name="temas" placeholder="Ingresa palabras clave (ej. Cálculo, Límites)">
                    </div>
        ...
        <div id="modalLoginWarning" class="modal-overlay">
            <div class="modal-content" style="max-width: 450px;">
                ...
                <div style="margin-top: 15px; padding: 10px;">
                    ...
                    <button onclick="window.location.href='crearCuenta.jsp'" class="btn-publicar" style="width: 100%; margin-bottom: 20px; background-color: #800020; padding: 12px; font-size: 1rem; border-radius: 25px;">Crear una cuenta</button>
                    <p style="margin-bottom: 5px; color: #333;">¿Ya eres parte de la comunidad?</p>
                    <a href="iniciarSesion.jsp" style="color: #800020; font-weight: bold; text-decoration: underline;">Iniciar Sesión</a>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            // --- DETECTAR ACCIONES EXITOSAS EN URL (Redirección del Servlet) ---
            window.addEventListener('DOMContentLoaded', () => {
                ...
                if (urlParams.get('exito') === 'true') {
                    ...
                    if (mensaje) {
                        ...
                        modalExito.classList.add('show-modal'); // Dispara animación
                    }
                }
            });

            function cerrarModalExito() {
                modalExito.classList.remove('show-modal');
            ...
            // Abrir formulario para nueva publicación
            btnAbrir.addEventListener('click', () => {
                if (isLoggedIn) {
                    ...
                    modalPregunta.classList.add('show-modal');
                } else {
            ...
            function abrirModalEditar(elemento) {
                ...
                document.getElementById('form_id_publicacion').value = elemento.getAttribute('data-id');
                document.getElementById('titulo').value = elemento.getAttribute('data-titulo');
                document.getElementById('contenido_pregunta').value = elemento.getAttribute('data-contenido');
                document.getElementById('id_categoria').value = elemento.getAttribute('data-categoria');
                document.getElementById('temas').value = elemento.getAttribute('data-temas');

                modalPregunta.classList.add('show-modal');
            }

            btnCerrarPregunta.addEventListener('click', () => modalPregunta.classList.remove('show-modal'));
            btnCerrarWarning.addEventListener('click', () => modalWarning.classList.remove('show-modal'));
            function cerrarModalConfirmar() { modalConfirmar.classList.remove('show-modal'); }

            // Cerrar modales clicando fuera del recuadro
            window.addEventListener('click', (e) => {
                if (e.target === modalPregunta) modalPregunta.classList.remove('show-modal');
                if (e.target === modalWarning) modalWarning.classList.remove('show-modal');
                if (e.target === modalConfirmar) modalConfirmar.classList.remove('show-modal');
            ...
            inputBusqueda.addEventListener('keyup', function() {
                ...
                cards.forEach(card => {
                    ...
                    if (tituloEl) {
                        card.style.display = tituloEl.textContent.toLowerCase().includes(filtro) ? "" : "none";
                    }
                });
            });
            ...
            function abrirModalEliminar(id, titulo) {
                ...
                modalConfirmar.classList.add('show-modal');
